use {
    super::super::{camera::init_rays, camera::rays_axes, *},
...
fn rays_discr_6_4_att_3_4() {
    let rays = init_rays(2.0 * PI / 3.0, PI / 4.0, 6, 4);
...
fn rays_discr_6_5_att_center() {
    let rays = init_rays(2.0 * PI / 3.0, PI / 4.0, 6, 5);
